                    ...
                    Column(
                        ...
                        Button(
                            ...
                            Row(
                                ...
                                Text(text = stringResource(id = R.string.button_signIn).uppercase(),
                                   color = Color.White,
                        ...
                        Row(
                            ...
                            Text(text = stringResource(id = R.string.dont_account), color = Color(160,156,156))
                            ...
                            TextButton(
                                ...
                                Text(text = stringResource(id = R.string.sign_up), color = Color(207, 6, 240))
                            }
                        }
